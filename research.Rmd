...
### On-Going Projects
* Evaluation of P-value Combination Methods.
* Great Lakes ILC consortium collaboration data analysis.
* Evaluation of Elderly Patients Treatments Using Electronic Medical Records.

### Publications
* Li-Xuan Qin, **Jian Zou**, Jiejun Shi, Ann Lee, Aleksandra Mihailovic, Thalia A. Farazi, Thomas Tuschl, Samuel Singer (2019). Statistical Assessment of Depth Normalization for Small RNA Sequencing, *Submitted*
